    ...
    <div class="card">
      <div class="card-header">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">{{ accion }} cuenta corriente</li>
        </ol>
      </div>
      <div class="card-body">
        <b-form>
          ...
          >
            ...
            ></b-form-input>
            <div v-if="$page.props.errors.numero_cuenta" class="text-danger">
          ...
          <b-form-group id="input-group-3" label="Moneda:" label-for="input-3">
            ...
            <div v-if="$page.props.errors.moneda" class="text-danger">
              {{ $page.props.errors.moneda[0] }}
            </div>
          </b-form-group>
          <b-button
            v-if="accion == 'Crear'"
