                            ...
                            <div class="dropdown">
                                ...
                                >
                                    ...
                                    <span class="text-muted"
                                        >Yearly<i
                                            class="mdi mdi-chevron-down ml-1"
                                        ></i
                                    ></span>
                                </a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-8">
                                <p class="text-white font-size-18">
                                    Enhance your <b>Campaign</b> for better
                                    outreach <i class="mdi mdi-arrow-right"></i>
                                </p>
                                <div class="mt-4">
                                    <a
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0">
                                    <i
                                        class="mdi mdi-circle-medium text-primary mr-2"
                                    ></i>
                                    Desktops
                                </p>
                            </div>
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0">
                                    <i
                                        class="mdi mdi-circle-medium text-info mr-2"
                                    ></i>
                                    iPhones
                                </p>
                            </div>
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0">
                                    <i
                                        class="mdi mdi-circle-medium text-success mr-2"
                                    ></i>
                                    Android
                                </p>
                            </div>
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0">
                                    <i
                                        class="mdi mdi-circle-medium text-warning mr-2"
                                    ></i>
                                    Tablets
                                </p>
                            </div>
                        ...
                        <div class="row align-items-center no-gutters mt-3">
                            <div class="col-sm-3">
                                <p class="text-truncate mt-1 mb-0">
                                    <i
                                        class="mdi mdi-circle-medium text-purple mr-2"
                                    ></i>
                                    Cables
                                </p>
                            </div>
                                ...
                                >
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h6
                                                    class="font-size-15 mb-1 font-weight-normal"
                                                >
                                                    Glenn Holden
                                                </h6>
                                                <p
                                            ...
                                            <td
                                                class="text-muted font-weight-semibold text-right"
                                            >
                                                <i
                                        ...
                                        <tr>
                                            ...
                                            >
                                                <i
                                                    class="icon-xs icon mr-2 text-danger"
                            ...
                            <li class="feed-item">
                                <div class="feed-item-list">
                                    <p class="text-muted mb-1 font-size-13">
                                        Today<small class="d-inline-block ml-1"
                                            >12:20 pm</small
                                        >
                                    </p>
                                    <p class="mt-0 mb-0">
                                        Andrei Coman magna sed porta finibus,
                                        risus posted a new article:
                                        <span class="text-primary"
                                            >Forget UX Rowland</span
                                        >
                                    </p>
                                </div>
                            </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <div class="avatar-sm mx-auto mb-4">
                                ...
                                >
                                    <i
                                        class="mdi mdi-facebook text-primary"
                                    ></i>
                                </span>
                            </div>
                        ...
                        <div class="mt-3 text-center">
                            <a
                                href="#"
                                class="text-primary font-size-14 font-weight-medium"
                                >View All Sources
                            ...
                            >
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <i
                                                class="fab fa-cc-mastercard mr-1"
                                            ></i>
                                            Mastercard
                                        </td>
                                        <td>
