...
class TipoConceptoPolicy
{
    ...
    {
        return $user->can('Listar Tipos-Concepto');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\TiposConcepto  $tiposConcepto
     * @return mixed
     */
     ...
     * @return mixed
     */
    public function forceDelete(User $user, TiposConcepto $tiposConcepto)
    {
        //
    }
}
